...
public class ReadonlyBytesTests
{
	...
	//	var cutted1 = ReadonlyBytes.CutElders(1);
 //       var cutted2 = ReadonlyBytes.CutElders(0x100000000);
	//	var cutted3 = ReadonlyBytes.CutElders(0x100000001);
 //       Assert.AreEqual(1, cutted1);
	//	Assert.AreEqual(0, cutted2);
	//	Assert.AreEqual(1, cutted3);
	//}
